...
// --- 2) Публичные (internal) статические врапперы для использования в Set* вызовах ---
		...
		YdbProviderAdapter()
		{
			...
			var assembly = LinqToDB.Internal.Common.Tools.TryLoadAssembly(AssemblyName, null)
				?? throw new InvalidOperationException($"Cannot load assembly {AssemblyName}.");
			var protosAsembly = LinqToDB.Internal.Common.Tools.TryLoadAssembly(ProtosAssemblyName, null)
